...
def _worker_init_fn(worker_id): # dj: for fixed random seed
...
def create_dataloader(data_type='train'):
    ...
    g = torch.Generator() # dj: for fixed random seed
    g.manual_seed(0)      # dj: for fixed random seed
    data_loader = torch.utils.data.DataLoader(dataset=dataset,
                                              ...
                                              generator=g, # dj: for fixed random seed
                                              )
